...
public class ParejaOrdenada<T extends Comparable<T>, U extends Comparable<U>> extends Pareja<T, U> implements Comparable<ParejaOrdenada<T, U>> {
    ...
    @Override
    public int compareTo(ParejaOrdenada<T, U> otraPareja) {
